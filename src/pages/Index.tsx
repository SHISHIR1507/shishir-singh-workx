  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="min-h-screen flex items-center justify-center px-4 relative">
        <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-6xl lg:text-8xl font-bold text-black leading-tight">
              Shishir
              <br />
              <span className="text-[#7B8F71]">Singh</span>
            </h1>
            ...
            <div className="flex gap-4">
              <Button 
                ...
                className="bg-[#7B8F71] hover:bg-[#6B7F61] text-white px-8 py-3 rounded-none text-lg"
              >
                About Me
              </Button>
              <Button 
                ...
                variant="outline" 
                className="border-[#7B8F71] text-[#7B8F71] hover:bg-[#7B8F71] hover:text-white px-8 py-3 rounded-none text-lg"
              >
                My Work
              </Button>
            </div>
        ...
        >
          <ArrowDown className="w-6 h-6 text-[#7B8F71]" />
        </button>
      </section>
